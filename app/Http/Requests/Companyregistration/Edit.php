...
class Edit extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            //docs
            'commercialcertificate' => 'mimes:pdf,jpg,png,jpeg|max:5048',
            'nondebtorcertificate' => 'mimes:pdf,jpg,png,jpeg|max:5048',
            'republicdiary' => 'mimes:pdf,jpg,png,jpeg|max:5048',
            'bi' => 'mimes:pdf,jpg,png,jpeg|max:5048',
        ];
    }
