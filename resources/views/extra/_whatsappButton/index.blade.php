<a href="https://api.whatsapp.com/send/?phone=244941397045&text&type=phone_number&app_absent=0" target="_blank" title="Olá! Entre em contacto connosco." class="wpp-icon">

    <div class="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-3 ht_ctc_animation no-animations" id="ht-ctc-chat"
        ...
        <div class="ht_ctc_style ht_ctc_chat_style">
            <div style="display:flex;justify-content:center;align-items:center; ">
                ...
                <p class="ctc-analytics ctc_cta ctc_cta_stick ht-ctc-cta  ht-ctc-cta-hover "
                    style="padding: 0px 16px; line-height: 1.6; background-color: rgb(37, 211, 102); color: rgb(255, 255, 255); border-radius: 10px; margin: 0px 10px; order: 1; display: none;">
                </p>
