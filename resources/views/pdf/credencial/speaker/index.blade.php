...
<head>
    ...
    <title>Credenciamento - {{ $speaker->id }}</title>
    <style>
        * {
            margin: 0 !important;
            padding: 0 !important;
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 text-center" style="padding-top:220px!important;padding-left:20px!important;">
                ...
                <h1 class="text-center" style="font-size: 25;font-weight: bold; color:#FFFFFF;">
