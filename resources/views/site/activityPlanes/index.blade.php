...
@section('titulo', 'Planos de Actividades')
@section('content')
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Planos de Actividades</li>
                        </ul>
                        <h2 class="section-title">Planos de Actividades</h2>
                    </div>
                </div>
            </div>
        </div>
