...
@section('titulo', 'Mapa de Quotas e Joias')
@section('content')
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Mapa de Quotas e Joias</li>
                        </ul>
                        <h2 class="section-title">Mapa de Quotas e Joias</h2>
                    </div>
                </div>
            </div>
        </div>
