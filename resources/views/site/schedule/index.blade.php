...
@section('titulo', 'Agendas de Reuniões')
@section('content')
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Agendas de Reuniões</li>
                        </ul>
                        <h2 class="section-title">Agendas de Reuniões</h2>
                    </div>
                </div>
            </div>
        </div>
